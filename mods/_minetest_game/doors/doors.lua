...
minetest.register_craft({
	...
	recipe = {"doors:door_wood", "lord_ores:steel_ingot"}
})
...
minetest.register_craft({
	...
	recipe = {"doors:door_steel", "lord_ores:steel_ingot"}
})
...
minetest.register_craft({
	...
	recipe = {"doors:door_glass", "lord_ores:steel_ingot"}
})
...
minetest.register_craft({
	...
	recipe = {"doors:door_obsidian_glass", "lord_ores:steel_ingot"}
})
