...
minetest.register_alias("mapgen_stone_with_coal", "lord_ores:coal_ore")
minetest.register_alias("mapgen_stone_with_iron", "lord_ores:iron_ore")
minetest.register_alias("mapgen_mese", "lord_ores:mese_block")
