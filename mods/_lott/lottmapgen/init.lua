...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	local c_stonecopper = minetest.get_content_id("lord_ores:copper_ore")
	local c_stoneiron = minetest.get_content_id("lord_ores:iron_ore")
	local c_stonecoal = minetest.get_content_id("lord_ores:coal_ore")
