...
minetest.register_alias("stone_with_coal", "lord_ores:coal_ore")
minetest.register_alias("stone_with_iron", "lord_ores:iron_ore")
...
minetest.register_alias("mese", "lord_ores:mese_block")
...
minetest.register_alias("steelblock", "lord_ores:steel_block")
...
minetest.register_alias("lump_of_coal", "lord_ores:coal_lump")
minetest.register_alias("lump_of_iron", "lord_ores:iron_lump")
minetest.register_alias("lump_of_clay", "default:clay_lump")
minetest.register_alias("steel_ingot", "lord_ores:steel_ingot")
...
minetest.register_alias("moreores:mineral_gold", "lord_ores:gold_ore")
minetest.register_alias("moreores:gold_block", "lord_ores:gold_block")
minetest.register_alias("moreores:gold_lump", "lord_ores:gold_lump")
minetest.register_alias("moreores:gold_ingot", "lord_ores:gold_ingot")
minetest.register_alias("moreores:mineral_copper", "lord_ores:copper_ore")
minetest.register_alias("moreores:copper_lump", "lord_ores:copper_lump")
minetest.register_alias("moreores:copper_ingot", "lord_ores:copper_ingot")
minetest.register_alias("moreores:copper_block", "lord_ores:copper_block")
minetest.register_alias("moreores:bronze_ingot", "lord_ores:bronze_ingot")
minetest.register_alias("moreores:bronze_block", "lord_ores:bronze_block")

minetest.register_alias("diamonds:diamond_in_ground", "lord_ores:diamond_ore")
minetest.register_alias("diamonds:block", "lord_ores:diamond_block")
...
minetest.register_alias("default:stone_with_coal", "lord_ores:coal_ore")
minetest.register_alias("default:coalblock", "lord_ores:coal_block")
minetest.register_alias("default:stone_with_iron", "lord_ores:_ore")
minetest.register_alias("default:steelblock", "lord_ores:steel_block")
minetest.register_alias("default:stone_with_copper", "lord_ores:_ore")
minetest.register_alias("default:copperblock", "lord_ores:copper_block")
minetest.register_alias("default:bronzeblock", "lord_ores:bronze_block")
minetest.register_alias("default:stone_with_mese", "lord_ores:_ore")
minetest.register_alias("default:mese", "lord_ores:mese_block")
minetest.register_alias("default:stone_with_gold", "lord_ores:_ore")
minetest.register_alias("default:goldblock", "lord_ores:gold_block")
minetest.register_alias("default:stone_with_diamond", "lord_ores:_ore")
minetest.register_alias("default:diamondblock", "lord_ores:diamond_block")

minetest.register_alias("default:bronze_ingot", "lord_ores:bronze_ingot")
minetest.register_alias("default:coal_lump", "lord_ores:coal_lump")
minetest.register_alias("default:copper_ingot", "lord_ores:bronze_ingot")
minetest.register_alias("default:copper_lump", "lord_ores:copper_lump")
minetest.register_alias("default:diamond", "lord_ores:diamond")
minetest.register_alias("default:gold_ingot", "lord_ores:bronze_ingot")
minetest.register_alias("default:gold_lump", "lord_ores:gold_lump")
minetest.register_alias("default:iron_lump", "lord_ores:iron_lump")
minetest.register_alias("default:mese_crystal", "lord_ores:mese_crystal")
minetest.register_alias("default:mese_crystal_fragment", "lord_ores:mese_shard")
minetest.register_alias("default:steel_ingot", "lord_ores:bronze_ingot")

minetest.register_alias("lottores:limestone_ore", "lord_ores:limestone_ore")
minetest.register_alias("lottores:rough_rock", "lord_ores:rough_rock")
minetest.register_alias("lottores:silver_ore", "lord_ores:silver_ore")
minetest.register_alias("lottores:tin_ore", "lord_ores:tin_ore")
minetest.register_alias("lottores:lead_ore", "lord_ores:lead_ore")
minetest.register_alias("lottores:mithril_ore", "lord_ores:mithril_ore")
minetest.register_alias("lottores:blue_gem_ore", "lord_ores:blue_sapphire_ore")
minetest.register_alias("lottores:white_gem_ore", "lord_ores:white_diamond_ore")
minetest.register_alias("lottores:red_gem_ore", "lord_ores:red_ruby_ore")

minetest.register_alias("lottores:limestone_lump", "lord_ores:limestone_lump")
minetest.register_alias("lottores:rough_rock_lump", "lord_ores:rough_rock_lump")
minetest.register_alias("lottores:silver_lump", "lord_ores:silver_lump")
minetest.register_alias("lottores:silver_ingot", "lord_ores:silver_ingot")
minetest.register_alias("lottores:tin_lump", "lord_ores:tin_lump")
minetest.register_alias("lottores:tin_ingot", "lord_ores:tin_ingot")
minetest.register_alias("lottores:lead_lump", "lord_ores:lead_lump")
minetest.register_alias("lottores:lead_ingot", "lord_ores:lead_ingot")
minetest.register_alias("lottores:mithril_lump", "lord_ores:mithril_lump")
minetest.register_alias("lottores:mithril_ingot", "lord_ores:mithril_ingot")
minetest.register_alias("lottores:blue_gem", "lord_ores:unheated_blue_sapphire")
minetest.register_alias("lottores:red_gem", "lord_ores:unheated_red_ruby")
minetest.register_alias("lottores:white_gem", "lord_ores:unheated_white_diamond")

minetest.register_alias("lottores:limestone", "lord_ores:limestone_block")
minetest.register_alias("lottores:marble", "lord_ores:")
minetest.register_alias("lottores:silver_block", "lord_ores:silver_block")
minetest.register_alias("lottores:tin_block", "lord_ores:tin_block")
minetest.register_alias("lottores:lead_block", "lord_ores:lead_block")
minetest.register_alias("lottores:mithril_block", "lord_ores:mithril_block")

minetest.register_alias("lottother:purple_gem", "lord_ores:unheated_violet_alexandrite")
